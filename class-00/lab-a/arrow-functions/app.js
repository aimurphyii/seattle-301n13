...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log('let sum is', sum(1, 2, 3, 4));
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log('objectlit is ',objectLit());
...
Student.prototype.greeting = function(joe){
...
Student.prototype.scopeArrow = () => console.log('this is ',this);
...
//this gives us the properties (key/value pairs) of the Student constructor... the proprties for the object joe that we created.
// 2. What is "this" when joe.scopeArrow() is invoked?
//this gives us... nothing? It isn't scoping to our new Student joe object, but to "window"
// 3. Explain why "this" is different when an arrow function is used.
//the arrow function, expression, seems to have no further reach than what it is immediately dealing with, while the regular notation, declaration, has a larger reach.
