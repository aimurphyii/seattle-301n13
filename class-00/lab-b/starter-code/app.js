...
// TODO: Uncomment the following line of code to see the output in the browser console
// Note that the arrow function will cause this code to break! Because Student is no longer a constructor fn, arrow is not used to create constructor fn.
console.log(joe);
...
// TODO: Uncomment the following line of code to see the output in the browser console
// Note that the arrow function will cause this method to break!--there is no scope for this, this relates to nothing. You need to refer to the new object.
...
//this is the properties of the object that was created
// 2. What is "this" when joe.scopeArrow() is invoked?
//this doesnt exist becasue arrows don't have a prototype property~ 
